...
contract Milestone {
    ...
    function payout() public {
        ...
        if(commonsDonation > 0) {
            ...
            //TODO: Get the tokens out of the curve
    ...
    function proposeToCommons(address payable _commonsAddress) public {
        require(!isFunded, "Milestone is already funded.");
    ...
    function convertToDAI(uint tokenAmount) public {
        ...
        uint payoutAmount = commonsToken.burn(tokenAmount);
        ERC20 externalToken = commonsToken.externalToken();
        externalToken.transfer(msg.sender, payoutAmount);
    }
